...
export const BUILT_IN_SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    keywords: ["shadow", "opacity", "depth", "fade", "transparent"],
    sortOrder: 30,
    help: "Shadow and opacity.",
  },
  {
    id: "border",
    title: "Border",
    tab: "design",
    icon: React.createElement(TbBorderAll),
    keywords: [
      "border",
      "radius",
      "rounded",
  ...
  },
  {
    ...
    title: "Ring & Outline",
    tab: "design",
    icon: React.createElement(TbBorderOuter),
    keywords: ["ring", "outline", "focus", "offset"],
    hideKey: "ringOutline",
    sortOrder: 34,
