...
export const STYLE_VAR_MAP: Record<string, { category: string; label: string }> = {
  ...
  radiusBox: { category: "other", label: "Radius Box" },
  radiusField: { category: "other", label: "Radius Field" },
  radiusSelector: { category: "other", label: "Radius Selector" },
  sizeField: { category: "other", label: "Size Field" },
  sizeSelector: { category: "other", label: "Size Selector" },
  depth: { category: "other", label: "Depth" },
  noise: { category: "other", label: "Noise" },
