  ...
  return (
    ...
    >
      <div
        ref={ref}
        key={`tooltip-${dialog.key}`}
        className="border-base-300 bg-neutral text-base-content pointer-events-none absolute rounded-lg border px-3 py-1.5 text-xs font-normal whitespace-nowrap drop-shadow-2xl"
      >
        {dialog.value}
      </div>
    </div>
