...
import { OVERLAY_Z_TOOLTIP } from "../popovers/overlayZIndex";
...
/** Full hint UI — static-import only from `EditorEmptyLeafHint.tsx` (lazy chunk). */
export function EditorEmptyLeafHintView({
  selected,
  icon,
  selectedIcon,
  idleLabel,
