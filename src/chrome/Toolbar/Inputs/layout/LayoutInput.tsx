    ...
    <>
      ...
      {(mode === "full" || mode === "alignment") && (
        <ToolbarSection
          ...
          help="How child elements are arranged and aligned."
          footer={
            isFlex ? (
          ...
          {isFlex && (
            <>
              ...
              <ToolbarItem
                ...
                options={[
                  { label: "—", value: "" },
                  ...TailwindStyles.alignItems.map(v => ({
                    label: v.replace("items-", ""),
                    value: v,
                  })),
                ]}
              />
      ...
      {(mode === "full" || mode === "spacing") && (
        <ToolbarSection
          ...
          icon={<TbBoxModel />}
          full={1}
          help="Padding (inner space) and margin (outer space)."
          header={
            <TypeSelector
              types={spacingTypes}
              selectedType={spacingType}
              onTypeChange={setSpacingType}
            />
          }
        >
