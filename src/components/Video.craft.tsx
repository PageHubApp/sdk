...
const toHTML: ToHTMLFn = (props, _children, ctx) => {
  ...
  let src = "";
  switch (provider) {
    case "youtube": src = `https://www.youtube.com/embed/${videoId}`; break;
    case "vimeo": src = `https://player.vimeo.com/video/${videoId}?title=0&byline=0&portrait=0`; break;
    case "dailymotion": src = `https://www.dailymotion.com/embed/video/${videoId}`; break;
    case "wistia": src = `https://fast.wistia.net/embed/iframe/${videoId}`; break;
    default: src = videoId;
  }

  const iframe = tag("iframe", {
    src, class: cls || undefined, frameborder: "0",
