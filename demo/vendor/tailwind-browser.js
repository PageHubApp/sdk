...
(() => {
  ...
  function Se(e, r) {
      ...
      if (!(v === Qe && ((d = e.charCodeAt(p + 1)), d === se)))
        if (v === ze) (c === "" && (g = p), (c += e.slice(p, p + 2)), (p += 1));
          ...
          if (w.charCodeAt(2) === qo) {
            ...
            (l.push(x), o && ((x.src = [o, k, p + 1]), (x.dst = [o, k, p + 1])));
          }
        } else if (v === tr || v === er) {
          let k = nr(e, p, v, o);
          ((c += e.slice(p, k + 1)), (p = k));
          ...
          if (
            (v === _e || v === se || v === Ue) &&
            (d = e.charCodeAt(p + 1)) &&
            (d === _e || d === se || d === Ue || (d === Qe && (d = e.charCodeAt(p + 2)) && d == se))
          )
            continue;
          if (v === se) {
            if (c.length === 0) continue;
            ((d = c.charCodeAt(c.length - 1)), d !== _e && d !== se && d !== Ue && (c += " "));
            ...
            for (let C = p + 2; C < e.length; C++)
              if (((d = e.charCodeAt(C)), d === ze)) C += 1;
                ...
                (d === or || d === Bo || d === $t) &&
                  ...
                  (k = k.slice(0, -1));
            let V = Nt(c, x);
            if (!V) throw new ue("Invalid custom property, expected a value", o ? [o, w, p] : null);
            ...
            if (!k) {
              if (c.length === 0) continue;
              throw new ue(`Invalid declaration: \`${c.trim()}\``, o ? [o, g, p] : null);
            }
            ...
            if (u === "") throw new ue("Missing opening {", o ? [o, p, p] : null);
            if (((u = u.slice(0, -1)), c.length > 0))
              if (c.charCodeAt(0) === Tt)
                ...
                if (a) {
                  ...
                  if (!x)
                    throw new ue(`Invalid declaration: \`${c.trim()}\``, o ? [o, g, p] : null);
                  (o && ((x.src = [o, g, p]), (x.dst = [o, g, p])), a.nodes.push(x));
                }
              }
            let k = s.pop() ?? null;
            ...
            if (u[u.length - 1] !== ")") throw new ue("Missing opening (", o ? [o, p, p] : null);
            ((u = u.slice(0, -1)), (c += ")"));
          } else {
    ...
    if (c.charCodeAt(0) === Tt) {
      let p = De(c);
      (o && ((p.src = [o, g, e.length]), (p.dst = [o, g, e.length])), t.push(p));
    }
    if (u.length > 0 && a) {
      if (a.kind === "rule")
        throw new ue(
  ...
  function nr(e, r, o, t = null) {
    ...
    for (let s = r + 1; s < e.length; s++)
      if (((l = e.charCodeAt(s)), l === ze)) s += 1;
        ...
        if (
          l === Je &&
          (e.charCodeAt(s + 1) === se || (e.charCodeAt(s + 1) === Qe && e.charCodeAt(s + 2) === se))
        )
          throw new ue(
  ...
  var et = class {
    ...
    keysInNamespaces(r) {
      ...
      for (let t of r) {
        ...
        for (let s of this.values.keys())
          s.startsWith(l) && s.indexOf("--", 2) === -1 && (lr(s, t) || o.push(s.slice(l.length)));
      }
      return o;
    }
    get(r) {
    ...
    #t(r) {
      ...
      if (!o) return null;
      let t = null;
      return (o.options & 2 && (t = o.value), `var(${ve(this.prefixKey(r))}${t ? `, ${t}` : ""})`);
    }
    markUsedVariable(r) {
      let o = me(this.#r(r)),
        t = this.values.get(o);
  ...
  function kr(e, r = () => O.Continue, o = () => O.Continue) {
    ...
    for (; t !== null; ) {
      ...
      switch (d.kind) {
        ...
        default:
          throw new Error(`Invalid \`WalkAction.${Vt[d.kind] ?? `Unknown(${d.kind})`}\` in exit.`);
      }
    }
  }
  function tt(e) {
              ...
              if (
                (U(P.nodes, j => {
                  ...
                  do {
                    ...
                    if ((le.add(n), (y = !0), (B = r.theme.resolveValue(null, [ae.value])), !B)) {
                      L = !0;
                      return;
                    }
...
`),
  ...
  function* Cr(e, r) {
    ...
    if (a[a.length - 1] === "]") {
      ...
      let v = a.slice(d + 2, -1),
        k = D(v, ":"),
        w = null;
      if ((k.length === 2 && ((w = k[0]), (v = k[1])), v[0] !== "-" || v[1] !== "-" || !he(v)))
        return;
    ...
    for (let [d, p] of g) {
      ...
      }
      {
        ...
        if (k !== -1) {
          ...
          let x = m === null || v.modifier?.kind === "arbitrary" ? null : `${p}/${m}`;
  ...
  function Nr(e, r) {
    ...
    return (
      ...
      (r.kind === "arbitrary" || r.kind === "functional") && (t += Sr(r.modifier)),
      r.important && (t += "!"),
      o.push(t),
      o.join(":")
    );
  ...
  function Sr(e) {
    ...
    let r = Dt(e.value),
      ...
      [t, l] = r ? ["(", ")"] : ["[", "]"];
    return e.kind === "arbitrary" ? `/${t}${Ve(o)}${l}` : e.kind === "named" ? `/${e.value}` : "";
  }
  function it(e) {
    ...
    return (
      e.kind === "compound" && ((r += e.root), (r += "-"), (r += it(e.variant))),
      (e.kind === "functional" || e.kind === "compound") && (r += Sr(e.modifier)),
      r
    );
  }
  var ni = new H(e => {
  ...
  function mi(e) {
    return D(e, " ").every(r => nt(r) || Rr(r) || r === "thin" || r === "medium" || r === "thick");
  }
    ...
    return D(e, ",")
      .map(t => {
        ...
        for (let u of l)
          _i.has(u) ||
            (Pr.test(u)
              ? (a === null ? (a = u) : m === null && (m = u), (Pr.lastIndex = 0))
              : s === null && (s = u));
  ...
  function Dr(e) {
    ...
    function o(n, f) {
      function* h(b) {
        for (let T of e.keysInNamespaces(b)) yield T.replace(Ur, (z, N, S) => `${N}.${S}`);
      }
      let A = [
        "1/2",
        "1/3",
      ...
      r.suggest(n, () => {
        ...
        for (let T of f()) {
          ...
          (T.supportsFractions && z.push(...A),
            ...
            b.push({ supportsNegative: T.supportsNegative, values: z, modifiers: N }));
        }
        return b;
      });
    }
    function t(n, f) {
      r.static(n, () => f.map(h => (typeof h == "function" ? h() : i(h[0], h[1]))));
    }
    function l(n, f) {
      f.staticValues && (f.staticValues = Object.assign(Object.create(null), f.staticValues));
        ...
        return b => {
          ...
          if (b.value)
            if (b.value.kind === "arbitrary") {
              ...
              if (
                ((T = e.resolve(b.value.fraction ?? b.value.value, f.themeKeys ?? [])),
              ...
              if (T === null && A && f.handleNegativeBareValue) {
                if (((T = f.handleNegativeBareValue(b.value)), !T?.includes("/") && b.modifier))
                  return;
              ...
              if (
                T === null &&
                f.handleBareValue &&
                ((T = f.handleBareValue(b.value)), !T?.includes("/") && b.modifier)
              )
                return;
            ...
            if (b.modifier) return;
            T = f.defaultValue !== void 0 ? f.defaultValue : e.resolve(null, f.themeKeys ?? []);
          }
    ...
    function a(
      ...
      f,
      h,
      { supportsNegative: A = !1, supportsFractions: b = !1, staticValues: T } = {}
    ) {
    ...
    (t("isolate", [["isolation", "isolate"]]),
      ...
      l("order", {
        ...
        themeKeys: ["--order"],
        handle: n => [i("order", n)],
        staticValues: { first: [i("order", "-9999")], last: [i("order", "9999")] },
      }),
      o("order", () => [
        {
          supportsNegative: !0,
      ...
      o("col-span", () => [
        { values: Array.from({ length: 12 }, (n, f) => `${f + 1}`), valueThemeKeys: [] },
      ]),
      o("col-start", () => [
        {
          supportsNegative: !0,
    ...
    for (let [n, f] of [
      ...
      (t(`${n}-auto`, [[f, "auto"]]),
        a(n, ["--margin", "--spacing"], h => [i(f, h)], { supportsNegative: !0 }));
    (t("box-border", [["box-sizing", "border-box"]]),
      ...
      l("aspect", {
        ...
        staticValues: { auto: [i("aspect-ratio", "auto")], square: [i("aspect-ratio", "1 / 1")] },
      }));
    for (let [n, f] of [
      ["full", "100%"],
      ["svw", "100svw"],
    ...
    (r.static("container", () => {
      ...
      for (let h of n) f.push(M("@media", `(width >= ${h})`, [i("max-width", h)]));
      return f;
    }),
      ...
      r.functional("flex", n => {
        if (n.value) {
          ...
          if (n.value.fraction) {
            ...
            return !E(f) || !E(h) ? void 0 : [i("flex", `calc(${n.value.fraction} * 100%)`)];
          }
          if (E(n.value.value)) return n.modifier ? void 0 : [i("flex", n.value.value)];
        }
      }),
      o("flex", () => [
        { supportsFractions: !0 },
      ...
      a("basis", ["--flex-basis", "--spacing", "--container"], n => [i("flex-basis", n)], {
        supportsFractions: !0,
      }),
    ...
    let m = () =>
      I([$("--tw-border-spacing-x", "0", "<length>"), $("--tw-border-spacing-y", "0", "<length>")]);
    (a("border-spacing", ["--border-spacing", "--spacing"], n => [
      m(),
      i("--tw-border-spacing-x", n),
      i("--tw-border-spacing-y", n),
      i("border-spacing", "var(--tw-border-spacing-x) var(--tw-border-spacing-y)"),
    ]),
    ...
    let c = () =>
      I([$("--tw-translate-x", "0"), $("--tw-translate-y", "0"), $("--tw-translate-z", "0")]);
    ...
    (a(
      ...
      n => [
        c(),
        i("--tw-translate-z", n),
        i("translate", "var(--tw-translate-x) var(--tw-translate-y) var(--tw-translate-z)"),
      ],
      { supportsNegative: !0 }
    ),
      t("translate-3d", [
    ...
    let u = () => I([$("--tw-scale-x", "1"), $("--tw-scale-y", "1"), $("--tw-scale-z", "1")]);
    ...
    function g({ negative: n }) {
      return f => {
        ...
        return f.value.kind === "arbitrary"
          ? ((h = f.value.value), (h = n ? `calc(${h} * -1)` : h), [i("scale", h)])
    ...
    for (let n of ["x", "y", "z"])
      (l(`scale-${n}`, {
        ...
        handle: f => [
          u(),
          i(`--tw-scale-${n}`, f),
          i("scale", `var(--tw-scale-x) var(--tw-scale-y)${n === "z" ? " var(--tw-scale-z)" : ""}`),
        ],
      }),
        o(`scale-${n}`, () => [
          {
      ...
      ]));
    {
      ...
      (l("skew", {
        ...
        l("skew-x", {
          ...
          themeKeys: ["--skew"],
          handleBareValue: ({ value: h }) => (E(h) ? `${h}deg` : null),
          handle: h => [f(), i("--tw-skew-x", `skewX(${h})`), i("transform", n)],
        }),
        l("skew-y", {
          supportsNegative: !0,
          themeKeys: ["--skew"],
          handleBareValue: ({ value: h }) => (E(h) ? `${h}deg` : null),
          handle: h => [f(), i("--tw-skew-y", `skewY(${h})`), i("transform", n)],
        }),
        o("skew", () => [
          {
            supportsNegative: !0,
    ...
    for (let n of ["x", "y", "both"])
      t(`snap-${n}`, [v, ["scroll-snap-type", `${n} var(--tw-scroll-snap-strictness)`]]);
    ...
    for (let [n, f] of [
      ...
      a(n, ["--scroll-margin", "--spacing"], h => [i(f, h)], { supportsNegative: !0 });
    for (let [n, f] of [
    ...
    (t("grid-flow-row", [["grid-auto-flow", "row"]]),
      ...
      l("grid-cols", {
        ...
        handleBareValue: ({ value: n }) => (Lt(n) ? `repeat(${n}, minmax(0, 1fr))` : null),
      ...
      a(
        ...
        n => [
          ...
          q(":where(& > :not(:last-child))", [
            ...
            i("margin-inline-end", `calc(${n} * calc(1 - var(--tw-space-x-reverse)))`),
          ]),
        ],
        { supportsNegative: !0 }
      ),
      a(
        ...
        n => [
          ...
          q(":where(& > :not(:last-child))", [
            ...
            i("margin-block-end", `calc(${n} * calc(1 - var(--tw-space-y-reverse)))`),
          ]),
        ],
        { supportsNegative: !0 }
      ),
      ...
      s("caret", { themeKeys: ["--caret-color", "--color"], handle: n => [i("caret-color", n)] }),
      s("divide", {
      ...
      ]));
    {
      let f = function (h, A) {
        (r.functional(h, b => {
          ...
          if (b.value.kind === "arbitrary") {
            let T = b.value.value;
            switch (b.value.dataType ?? Z(T, ["color", "line-width", "length"])) {
              case "line-width":
              case "length": {
                if (b.modifier) return;
                let N = A.width(T);
              ...
              default:
                return ((T = X(T, b.modifier, e)), T === null ? void 0 : A.color(T));
            }
          }
          {
      ...
      (f("border", {
        width: h => [i("border-style", "var(--tw-border-style)"), i("border-width", h)],
        ...
        f("border-t", {
          width: h => [i("border-top-style", "var(--tw-border-style)"), i("border-top-width", h)],
        ...
        f("border-l", {
          width: h => [i("border-left-style", "var(--tw-border-style)"), i("border-left-width", h)],
        ...
        l("divide-x", {
          ...
          handle: h => [
            ...
            q(":where(& > :not(:last-child))", [
              ...
              i("--tw-divide-x-reverse", "0"),
              i("border-inline-style", "var(--tw-border-style)"),
              i("border-inline-start-width", `calc(${h} * var(--tw-divide-x-reverse))`),
              i("border-inline-end-width", `calc(${h} * calc(1 - var(--tw-divide-x-reverse)))`),
            ]),
          ],
        }),
        l("divide-y", {
          ...
          handle: h => [
            ...
            q(":where(& > :not(:last-child))", [
              ...
              i("border-bottom-width", `calc(${h} * calc(1 - var(--tw-divide-y-reverse)))`),
            ]),
          ],
        }),
        o("divide-x", () => [
        ...
        t("divide-x-reverse", [
          () => I([$("--tw-divide-x-reverse", "0")]),
          () => q(":where(& > :not(:last-child))", [i("--tw-divide-x-reverse", "1")]),
        ]),
        t("divide-y-reverse", [
          () => I([$("--tw-divide-y-reverse", "0")]),
          () => q(":where(& > :not(:last-child))", [i("--tw-divide-y-reverse", "1")]),
        ]));
                ...
                case "angle":
                  return (
                    ...
                    [
                      ...
                      i("background-image", `linear-gradient(var(--tw-gradient-stops,${F}))`),
                    ]
                  );
                default:
                  return T
        ...
        b = function ({ negative: T }) {
          return z => {
            if (z.value?.kind === "arbitrary") {
              ...
              return [
                i("--tw-gradient-position", F),
                i("background-image", `conic-gradient(var(--tw-gradient-stops,${F}))`),
              ];
            }
            let N = h(z.modifier);
            if (!z.value)
              return [
                i("--tw-gradient-position", N),
                i("background-image", "conic-gradient(var(--tw-gradient-stops))"),
              ];
            let S = z.value.value;
            if (E(S))
              return (
        ...
        r.functional("bg-radial", T => {
          if (!T.value) {
            ...
            return [
              ...
              i("background-image", "radial-gradient(var(--tw-gradient-stops))"),
            ];
          }
          if (T.value.kind === "arbitrary") {
            ...
            return [
              i("--tw-gradient-position", z),
              i("background-image", `radial-gradient(var(--tw-gradient-stops,${z}))`),
            ];
          }
        }),
    ...
    (r.functional("bg", n => {
      if (n.value) {
        if (n.value.kind === "arbitrary") {
          ...
          switch (
            n.value.dataType ??
            Z(f, ["image", "color", "percentage", "position", "bg-size", "length", "url"])
          ) {
            case "percentage":
            case "position":
            ...
            default:
              return ((f = X(f, n.modifier, e)), f === null ? void 0 : [i("background-color", f)]);
          }
        }
        {
        ...
        if (h.value) {
          ...
          }
          {
            ...
            switch (A) {
              ...
              case "percentage":
                return E(h.value.value.slice(0, -1)) ? f.position(h.value.value) : void 0;
              default:
                return;
            }
          }
      ...
      V(n, {
        color(A) {
          let b = [
            x(),
            C(),
            i("mask-image", "var(--tw-mask-linear), var(--tw-mask-radial), var(--tw-mask-conic)"),
    ...
    (t("mix-blend-plus-darker", [["mix-blend-mode", "plus-darker"]]),
      ...
      r.functional("stroke", n => {
        if (n.value) {
          if (n.value.kind === "arbitrary") {
            let f = n.value.value;
            switch (n.value.dataType ?? Z(f, ["color", "number", "length", "percentage"])) {
              case "number":
              case "length":
              case "percentage":
    ...
    (t("text-left", [["text-align", "left"]]),
      ...
      a("indent", ["--text-indent", "--spacing"], n => [i("text-indent", n)], {
        supportsNegative: !0,
      }),
      ...
      r.functional("font", n => {
        if (!(!n.value || n.modifier)) {
          if (n.value.kind === "arbitrary") {
            let f = n.value.value;
            switch (n.value.dataType ?? Z(f, ["number", "generic-name", "family-name"])) {
              case "generic-name":
              case "family-name":
                return [i("font-family", f)];
              default:
                return [I([$("--tw-font-weight")]), i("--tw-font-weight", f), i("font-weight", f)];
            }
          }
          {
            let f = e.resolveWith(
      ...
      l("font-features", { themeKeys: [], handle: n => [i("font-feature-settings", n)] }),
      ...
      s("placeholder", {
        ...
        handle: n => [q("&::placeholder", [i("--tw-sort", "placeholder-color"), i("color", n)])],
      }),
      ...
      r.functional("decoration", n => {
        if (n.value) {
          if (n.value.kind === "arbitrary") {
            let f = n.value.value;
            switch (n.value.dataType ?? Z(f, ["color", "length", "percentage"])) {
              case "length":
              case "percentage":
          ...
          }
          {
            ...
            if (f) return n.modifier ? void 0 : [i("text-decoration-thickness", f)];
            if (E(n.value.value))
              return n.modifier ? void 0 : [i("text-decoration-thickness", `${n.value.value}px`)];
          }
          {
      ...
      }));
    {
      ...
      (r.functional("filter", b => {
        ...
        r.functional("backdrop-filter", b => {
          if (!b.modifier) {
            if (b.value === null)
              return [A(), i("-webkit-backdrop-filter", f), i("backdrop-filter", f)];
            if (b.value.kind === "arbitrary")
              return [
            ...
            switch (b.value.value) {
              case "none":
                return [i("-webkit-backdrop-filter", "none"), i("backdrop-filter", "none")];
            }
          }
        }),
        l("blur", {
        ...
        l("brightness", {
          ...
          handle: b => [h(), i("--tw-brightness", `brightness(${b})`), i("filter", n)],
        }),
        ...
        l("contrast", {
          themeKeys: ["--contrast"],
          handleBareValue: ({ value: b }) => (E(b) ? `${b}%` : null),
          handle: b => [h(), i("--tw-contrast", `contrast(${b})`), i("filter", n)],
        }),
        l("backdrop-contrast", {
        ...
        l("grayscale", {
          ...
          handleBareValue: ({ value: b }) => (E(b) ? `${b}%` : null),
          defaultValue: "100%",
          handle: b => [h(), i("--tw-grayscale", `grayscale(${b})`), i("filter", n)],
        }),
        ...
        l("hue-rotate", {
          ...
          handle: b => [h(), i("--tw-hue-rotate", `hue-rotate(${b})`), i("filter", n)],
        }),
        ...
        l("invert", {
          ...
          handleBareValue: ({ value: b }) => (E(b) ? `${b}%` : null),
          defaultValue: "100%",
          handle: b => [h(), i("--tw-invert", `invert(${b})`), i("filter", n)],
        }),
        l("backdrop-invert", {
        ...
        l("saturate", {
          themeKeys: ["--saturate"],
          handleBareValue: ({ value: b }) => (E(b) ? `${b}%` : null),
          handle: b => [h(), i("--tw-saturate", `saturate(${b})`), i("filter", n)],
        }),
        l("backdrop-saturate", {
          ...
          if (
            ...
            return z === null || N === null
              ...
              : [
                  ...
                  ...at("--tw-drop-shadow-size", z, T, S => `var(--tw-drop-shadow-color, ${S})`),
                  i(
                    "--tw-drop-shadow",
                    D(N, ",")
                      .map(S => `drop-shadow(${S})`)
              ...
              case "color":
                return (
                  ...
                  z === null
                    ...
                    : [
                        h(),
                        i("--tw-drop-shadow-color", Q(z, "var(--tw-drop-shadow-alpha)")),
    ...
    }
    {
      ...
      l("ease", {
        themeKeys: ["--ease"],
        handle: f => [n(), i("--tw-ease", f), i("transition-timing-function", f)],
        staticValues: {
          initial: [n(), i("--tw-ease", "initial")],
          linear: [n(), i("--tw-ease", "linear"), i("transition-timing-function", "linear")],
        },
      });
    }
      ...
      }));
    {
      ...
      (t("contain-none", [["contain", "none"]]),
        ...
        t("contain-inline-size", [f, ["--tw-contain-size", "inline-size"], ["contain", n]]),
        t("contain-layout", [f, ["--tw-contain-layout", "layout"], ["contain", n]]),
        t("contain-paint", [f, ["--tw-contain-paint", "paint"], ["contain", n]]),
        t("contain-style", [f, ["--tw-contain-style", "style"], ["contain", n]]),
    ...
    (t("forced-color-adjust-none", [["forced-color-adjust", "none"]]),
      ...
      a(
        "leading",
        ["--leading", "--spacing"],
        n => [I([$("--tw-leading")]), i("--tw-leading", n), i("line-height", n)],
        {
          staticValues: {
            none: [I([$("--tw-leading")]), i("--tw-leading", "1"), i("line-height", "1")],
          },
        }
      ),
      l("tracking", {
        supportsNegative: !0,
        themeKeys: ["--tracking"],
        handle: n => [I([$("--tw-tracking")]), i("--tw-tracking", n), i("letter-spacing", n)],
      }),
      t("antialiased", [
      ...
      ]));
    {
      ...
      (t("normal-nums", [["font-variant-numeric", "normal"]]),
        t("ordinal", [f, ["--tw-ordinal", "ordinal"], ["font-variant-numeric", n]]),
        t("slashed-zero", [f, ["--tw-slashed-zero", "slashed-zero"], ["font-variant-numeric", n]]),
        t("lining-nums", [f, ["--tw-numeric-figure", "lining-nums"], ["font-variant-numeric", n]]),
        t("oldstyle-nums", [
          f,
      ...
      (r.static("outline-hidden", () => [
        ...
        r.functional("outline", f => {
          if (f.value === null) {
            ...
            return [n(), i("outline-style", "var(--tw-outline-style)"), i("outline-width", h)];
          }
          if (f.value.kind === "arbitrary") {
            let h = f.value.value;
            switch (f.value.dataType ?? Z(h, ["color", "length", "number", "percentage"])) {
              ...
              case "percentage":
                return f.modifier
                  ? void 0
                  : [n(), i("outline-style", "var(--tw-outline-style)"), i("outline-width", h)];
              default:
                return ((h = X(h, f.modifier, e)), h === null ? void 0 : [i("outline-color", h)]);
            }
          }
          {
      ...
      r.functional("text", n => {
        if (n.value) {
          if (n.value.kind === "arbitrary") {
            ...
            switch (
              n.value.dataType ??
              Z(f, ["color", "length", "percentage", "absolute-size", "relative-size"])
            ) {
              case "size":
              case "length":
              case "percentage":
              ...
              default:
                return ((f = X(f, n.modifier, e)), f === null ? void 0 : [i("color", f)]);
            }
          }
          {
    ...
    let L = () =>
      I([$("--tw-text-shadow-color"), $("--tw-text-shadow-alpha", "100%", "<percentage>")]);
    (t("text-shadow-initial", [L, ["--tw-text-shadow-color", "initial"]]),
      r.functional("text-shadow", n => {
        ...
        if (
          ...
          return h === null
            ...
            : [
                ...
                ...ke("text-shadow", h, f, A => `var(--tw-text-shadow-color, ${A})`),
              ];
        }
        if (n.value.kind === "arbitrary") {
          let h = n.value.value;
          switch (n.value.dataType ?? Z(h, ["color"])) {
            case "color":
              return (
                ...
                h === null
                  ? void 0
                  : [L(), i("--tw-text-shadow-color", Q(h, "var(--tw-text-shadow-alpha)"))]
              );
            default:
              return [
                L(),
                i("--tw-text-shadow-alpha", f),
                ...ke("text-shadow", h, f, b => `var(--tw-text-shadow-color, ${b})`),
              ];
          }
        }
        ...
        }
        {
          ...
          if (h) return [L(), i("--tw-text-shadow-color", Q(h, "var(--tw-text-shadow-alpha)"))];
        }
      }),
      o("text-shadow", () => [
        {
      ...
      ]));
    {
      ...
      (t("shadow-initial", [h, ["--tw-shadow-color", "initial"]]),
        r.functional("shadow", N => {
          ...
          if (
            ...
            return F === null
              ...
              : [
                  h(),
                  i("--tw-shadow-alpha", S),
                  ...ke("--tw-shadow", F, S, fe => `var(--tw-shadow-color, ${fe})`),
                  i("box-shadow", n),
                ];
          }
          if (N.value.kind === "arbitrary") {
            ...
            switch (N.value.dataType ?? Z(F, ["color"])) {
              case "color":
                return (
                  ...
                  F === null
                    ? void 0
                    : [h(), i("--tw-shadow-color", Q(F, "var(--tw-shadow-alpha)"))]
                );
              default:
                return [
                  h(),
                  i("--tw-shadow-alpha", S),
                  ...ke("--tw-shadow", F, S, Ct => `var(--tw-shadow-color, ${Ct})`),
                  i("box-shadow", n),
                ];
            }
          }
          switch (N.value.value) {
            case "none":
              return N.modifier ? void 0 : [h(), i("--tw-shadow", f), i("box-shadow", n)];
            case "inherit":
              return N.modifier ? void 0 : [h(), i("--tw-shadow-color", "inherit")];
          }
          {
          ...
          }
          {
            ...
            if (F) return [h(), i("--tw-shadow-color", Q(F, "var(--tw-shadow-alpha)"))];
          }
        }),
        o("shadow", () => [
          {
        ...
        r.functional("inset-shadow", N => {
          ...
          if (
            ...
            return F === null
              ...
              : [
                  ...
                  ...ke("--tw-inset-shadow", F, S, fe => `var(--tw-inset-shadow-color, ${fe})`),
                  i("box-shadow", n),
                ];
          }
          if (N.value.kind === "arbitrary") {
            ...
            switch (N.value.dataType ?? Z(F, ["color"])) {
              case "color":
                return (
                  ...
                  F === null
                    ? void 0
                    : [h(), i("--tw-inset-shadow-color", Q(F, "var(--tw-inset-shadow-alpha)"))]
                );
              default:
                return [
                  h(),
          ...
          switch (N.value.value) {
            case "none":
              return N.modifier ? void 0 : [h(), i("--tw-inset-shadow", f), i("box-shadow", n)];
            case "inherit":
              return N.modifier ? void 0 : [h(), i("--tw-inset-shadow-color", "inherit")];
          }
          {
          ...
          {
            let F = ee(N, e, ["--box-shadow-color", "--color"]);
            if (F) return [h(), i("--tw-inset-shadow-color", Q(F, "var(--tw-inset-shadow-alpha)"))];
          }
        }),
        o("inset-shadow", () => [
          {
      ...
      (r.functional("ring", N => {
        ...
        if (N.value.kind === "arbitrary") {
          ...
          switch (N.value.dataType ?? Z(S, ["color", "length"])) {
            case "length":
              return N.modifier ? void 0 : [h(), i("--tw-ring-shadow", b(S)), i("box-shadow", n)];
            default:
              return ((S = X(S, N.modifier, e)), S === null ? void 0 : [i("--tw-ring-color", S)]);
          }
        }
        {
        ...
        r.functional("inset-ring", N => {
          ...
          }
          {
            ...
            let S = e.resolve(N.value.value, ["--ring-width"]);
            if ((S === null && E(N.value.value) && (S = `${N.value.value}px`), S))
              return [h(), i("--tw-inset-ring-shadow", T(S)), i("box-shadow", n)];
          }
        }),
        o("inset-ring", () => [
          {
          ...
          if (N.value.kind === "arbitrary") {
            ...
            switch (N.value.dataType ?? Z(S, ["color", "length"])) {
              case "length":
                return N.modifier
                  ? void 0
                  : [i("--tw-ring-offset-width", S), i("--tw-ring-offset-shadow", z)];
              default:
                return (
                  (S = X(S, N.modifier, e)),
                ...
                return (
                  U(a.nodes, c => {
                    ...
                    for (let g of c.nodes)
                      if (g.kind === "word") {
                        if (g.value === "integer") t[u].usedSpacingInteger ||= !0;
                        else if (
                          g.value === "number" &&
...
`);
                    ...
                    (U(C, y => {
                      if (y.kind === "function") {
                        if (y.value === "--value") {
                          ...
                          let K = zr(a, y, o);
                          return K
                            ? ((u = !0), K.ratio ? (v = !0) : p.set(k, x), O.ReplaceSkip(K.nodes))
                            : ((c ||= !1), (V = !0), O.Stop);
            ...
            o.utilities.suggest(r.slice(0, -2), () => {
              ...
              for (let [
                a,
                { literals: m, usedSpacingNumber: c, usedSpacingInteger: u, themeKeys: g },
              ] of [
                [l, t["--value"]],
                [s, t["--modifier"]],
              ]) {
  ...
  function ke(e, r, o, t, l = "") {
      ...
      a = Ie(r, c =>
        o == null
          ...
          : c.startsWith("current")
            ? t(Q(c, o))
            : ((c.startsWith("var(") || o.startsWith("var(")) && (s = !0), t(_r(c, o)))
      );
    function m(c) {
      return l
        ? D(c, ",")
    ...
    return s
      ? [i(e, m(Ie(r, t))), Y("@supports (color: lab(from red l a b))", [i(e, m(a))])]
      : [i(e, m(a))];
  }
    ...
    for (let s = 0; s < t.length; s++) {
      ...
      switch (a) {
        ...
        case Bi:
          continue;
        default: {
          if ((a >= ji && a <= Fi) || (a >= Ii && a <= Mi) || (a >= st && a <= ut)) continue;
          return !1;
        }
      }
    }
  ...
  function Hr(e) {
      ...
      r.compound("group", 2, (u, g) => {
        ...
        if (
          (U([u], (v, k) => {
            ...
            for (let x of k.path()) if (x.kind === "rule") return ((p = !1), O.Stop);
            let w = v.selector.replaceAll("&", d);
            (D(w, ",").length > 1 && (w = `:is(${w})`), (v.selector = `&:is(${w} *)`), (p = !0));
          }),
          !p)
        )
          return null;
      ...
      o("details-content", ["&::details-content"]));
    {
      ...
      (r.static(
        "before",
        g => {
          g.nodes = [q("&::before", [u(), i("content", "var(--tw-content)"), ...g.nodes])];
        },
        { compounds: 0 }
      ),
        r.static(
          "after",
          g => {
            g.nodes = [q("&::after", [u(), i("content", "var(--tw-content)"), ...g.nodes])];
          },
          { compounds: 0 }
        ));
    }
      ...
      o("contrast-less", ["@media (prefers-contrast: less)"]));
    {
      ...
      var c = u;
      {
        ...
        (r.group(
          ...
          r.suggest("max", () => Array.from(g.keys()).filter(p => p !== null)),
          r.group(
            () => {
          ...
          r.suggest("min", () => Array.from(g.keys()).filter(p => p !== null)));
      }
      {
  ...
  function Gr(e, r) {
    ...
    function c(d) {
      ...
      for (let v of d) {
        ...
        (r && U(w, x => ((x.src ??= r), O.Continue)), (w = Ce(w, g, 0)), p.push(k ? w : []));
      }
      return p;
    }
    function u(d) {
    ...
    let g = {
      ...
      getVariantOrder() {
        ...
        for (let w of d)
          w !== null &&
            (v !== void 0 && this.variants.compare(v, w) !== 0 && k++, p.set(w, k), (v = w));
        return p;
      },
  ...
  function dt(e, r, o, t = 0) {
    ...
    if (r.kind === "compound") {
      let a = M("@slot");
      if (dt(a, r.variant, o, t + 1) === null || (r.root === "not" && a.nodes.length > 1))
        return null;
      for (let c of a.nodes)
        if ((c.kind !== "rule" && c.kind !== "at-rule") || l(c, r) === null) return null;
      (U(a.nodes, c => {
    ...
    U([t], (d, p) => {
      if (d.kind === "at-rule") {
        ...
        if (d.name === "@apply") {
          ...
          ((o |= 1), l.add(p.parent));
          for (let v of Xr(d, r)) for (let k of p.path()) l.has(k) && s.get(k).add(v);
        }
      }
    });
    let m = new Set(),
...
${ie([v])}`)
        ...
        u.add(d);
        for (let v of s.get(d)) for (let k of a.get(v)) (p.push(d), g(k, p), p.pop());
                ...
                onInvalidCandidate: R => {
                  ...
                  if (P.length > 1) {
                    ...
                    if (r.candidatesToCss([L])[0]) {
                      let _ = r.candidatesToCss(P.map(W => `${W}:[--tw-variant-check:1]`)),
  ...
  function to(e, r = [], o) {
    for (let t of Reflect.ownKeys(e)) {
      ...
      if (a !== 1) {
        if (a === 2) return 2;
        if (!(!Array.isArray(l) && typeof l != "object") && to(l, s, o) === 2) return 2;
      }
    }
  }
  function fn(e) {
...
`
      ...
      switch (m) {
        ...
        case po: {
          ...
          for (
            ...
            u < e.length &&
            ((s = e.charCodeAt(u)),
            !(s !== io && s !== no && s !== lo && s !== co && s !== uo && s !== fo && s !== po));
            u++
          );
          a = u - 1;
          let g = e.slice(c, u),
        ...
        case so: {
          ...
          if (
            ...
            let d = a;
            (c.nodes.push(mn(e.slice(u, d))), (l = ""), (a = d), t ? t.nodes.push(c) : r.push(c));
            break;
          }
    ...
    return function (l, s) {
      ...
      let c = (() => {
        ...
        if (p !== null && typeof p == "object" && !Array.isArray(p)) {
          ...
          for (let k in g)
            k !== "__CSS_VALUES__" &&
              ((p?.__CSS_VALUES__?.[k] & 4 && mo(v, k.split("-")) !== void 0) || (v[me(k)] = g[k]));
          return v;
        }
        ...
        (e.variants.group(
          () => {
            e.variants.functional(m, (p, v) => {
              ...
              if (v.value.kind === "arbitrary") p.nodes = g(v.value.value, v.modifier, p.nodes);
          ...
          (p, v) => {
            ...
            let k = p.value ? p.value.value : "DEFAULT",
              ...
              V = (u?.values && Object.hasOwn(u.values, w) ? u.values[w] : void 0) ?? w;
          ...
          e.variants.suggest(m, () => Object.keys(u?.values ?? {}).filter(p => p !== "DEFAULT")));
      },
      addUtilities(m) {
        ...
        for (let [g, d] of c) {
          ...
          if (
            (U(p, k => {
              if (k.kind === "selector" && k.value[0] === "." && go.test(k.value.slice(1))) {
                let w = k.value;
                k.value = "&";
                let x = Be(p),
                  V = w.slice(1),
    ...
    for (let [t, l] of o)
      if (l != null && l !== !1)
        if (typeof l != "object") {
          ...
          for (let s of l) typeof s == "string" ? r.push(i(t, s)) : r.push(Y(t, de(s)));
  ...
  function vo(e, r, o) {
    U(e, t => {
      if (t.kind === "rule") {
        let l = ht(t.selector);
        (U(l, s => {
          s.kind === "selector" && s.value === `.${r}` && (s.value = `.${ve(o)}`);
        }),
          (t.selector = Be(l)));
      }
    });
  ...
  var ce = Ne(e => {
    ...
    xo = {
      ...
      borderWidth: { DEFAULT: "1px", 0: "0px", 2: "2px", 4: "4px", 8: "8px", ...xe },
      boxShadow: {
      ...
      container: {},
      content: { none: "none" },
      contrast: { 0: "0", 50: ".5", 75: ".75", 100: "1", 125: "1.25", 150: "1.5", 200: "2", ...oe },
      cursor: {
        auto: "auto",
        default: "default",
        pointer: "pointer",
      ...
      outlineOffset: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...xe },
      ...
      ringOffsetWidth: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...xe },
      ringOpacity: ({ theme: e }) => ({ DEFAULT: "0.5", ...e("opacity") }),
      ringWidth: { DEFAULT: "3px", 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...xe },
      rotate: {
        0: "0deg",
        1: "1deg",
        2: "2deg",
      ...
      skew: { 0: "0deg", 1: "1deg", 2: "2deg", 3: "3deg", 6: "6deg", 12: "12deg", ...wt },
  ...
  function Gt(e, { config: r, base: o, path: t, reference: l, src: s }) {
    ...
    for (let u of r.presets ?? []) Gt(e, { path: t, base: o, config: u, reference: l, src: s });
    for (let u of a)
      (e.plugins.push(u),
        u.config &&
          Gt(e, { path: t, base: o, config: u.config, reference: !!u.reference, src: u.src ?? s }));
    let m = r.content ?? [],
      c = Array.isArray(m) ? m : m.files;
    for (let u of c) e.content.files.push(typeof u == "object" ? u : { base: o, pattern: u });
    e.configs.push(r);
  }
  function En(e) {
    let r = new Set(),
  ...
  function Vn({ center: e, padding: r, screens: o }, t) {
    ...
    if (
      ...
      if ((a.sort((m, c) => $e(m[1], c[1], "asc")), a.length > 0)) {
        let [m] = a[0];
        l.push(M("@media", `(width >= --theme(--breakpoint-${m}))`, [i("max-width", "none")]));
      }
    ...
    if (typeof r == "object" && r !== null) {
      ...
      for (let [m, , c] of a)
        if (s && s.has(m)) s.get(m).nodes.push(i("padding-inline", c));
          ...
          if (s) continue;
          l.push(M("@media", `(width >= theme(--breakpoint-${m}))`, [i("padding-inline", c)]));
        }
    }
  ...
  function To(e) {
    ...
    (e.utilities.suggest("bg-left-top", () => []),
      e.utilities.static("bg-left-top", () => [i("background-position", "left top")]),
      e.utilities.suggest("bg-right-top", () => []),
      e.utilities.static("bg-right-top", () => [i("background-position", "right top")]),
      e.utilities.suggest("bg-left-bottom", () => []),
      e.utilities.static("bg-left-bottom", () => [i("background-position", "left bottom")]),
      e.utilities.suggest("bg-right-bottom", () => []),
      e.utilities.static("bg-right-bottom", () => [i("background-position", "right bottom")]),
      e.utilities.suggest("object-left-top", () => []),
      e.utilities.static("object-left-top", () => [i("object-position", "left top")]),
      e.utilities.suggest("object-right-top", () => []),
      e.utilities.static("object-right-top", () => [i("object-position", "right top")]),
      e.utilities.suggest("object-left-bottom", () => []),
      e.utilities.static("object-left-bottom", () => [i("object-position", "left bottom")]),
      e.utilities.suggest("object-right-bottom", () => []),
      e.utilities.static("object-right-bottom", () => [i("object-position", "right bottom")]),
      ...
      e.utilities.static("overflow-ellipsis", () => [i("text-overflow", "ellipsis")]),
      ...
      e.utilities.static("break-words", () => [i("overflow-wrap", "break-word")]));
    for (let [o, t] of [
      ...
      let l = function ({ negative: s }) {
        return a => {
          ...
          let m = e.theme.resolve(a.value.fraction ?? a.value.value, ["--inset", "--spacing"]);
          ...
          if (m === null && s) {
            ...
            if (c && ne(a.value.value) && ((m = `calc(${c} * -${a.value.value})`), m !== null))
              return [i(t, m)];
          }
          if (m === null) {
            let c = e.theme.resolve(null, ["--spacing"]);
  ...
  function No(e, r) {
    ...
    if (l.length !== 0) {
      ...
      r.variants.compareFns = new Map(
        Array.from(r.variants.compareFns).map(([a, m]) => (a > t && (a += l.length), [a, m]))
      );
  ...
  var On = /^[a-z]+$/;
  async function Vo({ designSystem: e, base: r, ast: o, loadModule: t, sources: l }) {
    let s = 0,
      a = [],
      m = [];
    (U(o, (d, p) => {
...
Using an object as a plugin option is currently only supported in JavaScript configuration files.`);
    ...
    return (
      (s |= Eo({ designSystem: e, base: r, ast: o, sources: l, configs: u, pluginDetails: g })),
      s
    );
  }
  function Eo({ designSystem: e, base: r, ast: o, sources: t, configs: l, pluginDetails: s }) {
    let a = 0,
      c = [
        ...s.map(w => {
          if (!w.options)
    ...
    if ((eo(e, g, d), wo(e, g), So(g, e), No(g, e), Co(g, e), !e.theme.prefix && u.prefix)) {
      if (
        (u.prefix.endsWith("-") &&
...
`)) {
      ...
      let g = a.find(l.src[2]),
        d = m.find(l.dst[2]);
      t.mappings.push({ name: null, originalPosition: { source: s, ...g }, generatedPosition: d });
    });
  ...
  async function Ln(e, { base: r = "", from: o, loadModule: t = Un, loadStylesheet: l = Dn } = {}) {
    let s = 0;
    ...
    U(e, (y, K) => {
      ...
      if (
        ...
        for (let L of P)
          if (L.startsWith("source(")) {
            ...
            V = { base: R.context.sourceBase ?? R.context.base, pattern: _.slice(1, -1) };
          }
        ((p = y), (s |= 16));
      }
      if (y.name === "@utility") {
      ...
      if (y.name === "@source") {
        ...
        if (
          ...
          _[0] === "i" && _.startsWith("inline(") && ((L = !0), (_ = _.slice(7, -1).trim())),
          (_[0] === '"' && _[_.length - 1] !== '"') ||
            (_[0] === "'" && _[_.length - 1] !== "'") ||
            (_[0] !== "'" && _[0] !== '"'))
        )
      ...
      if (
        ...
        if (y.nodes.length === 0) {
          ...
          let j = [],
            W = [];
          for (let B of _) ((B = B.trim()), B[0] === "@" ? j.push(B) : W.push(B));
          (c.set(P, B => {
            B.variants.static(
              P,
              le => {
      ...
      if (y.name === "@theme") {
        ...
        return (
          U(y.nodes, _ => {
            if (_.kind === "at-rule" && _.name === "@keyframes") return (m.addKeyframes(_), O.Skip);
...
`
              ...
              .map((W, B, le) => `${B === 0 || B >= le.length - 2 ? " " : ">"} ${W}`).join(`
`);
...
${j}`);
    ...
    s |= await Vo({ designSystem: C, base: r, ast: e, loadModule: t, sources: k });
    for (let y of c.keys()) C.variants.static(y, () => {});
    for (let y of Po(u, {
      onCircularDependency(K, R) {
        let P = ie(K.map((L, _) => M("@custom-variant", L, [M("@variant", K[_ + 1] ?? R, [])])))
          .replaceAll(";", " { \u2026 }")
...
${P}`);
  ...
  async function jn(e, r = {}) {
    ...
    t.unshift(Xe(`! tailwindcss v${Xt} | MIT License | https://tailwindcss.com `));
    function u(k) {
