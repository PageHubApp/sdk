...
let currentConfig = {
  apiBaseUrl: savedConfig.apiBaseUrl !== undefined ? savedConfig.apiBaseUrl : defaultConfig.apiBaseUrl,
...
function initEditor() {
  ...
  editor.on('ready', function () {
    ...
    if (draftQ) {
      ...
      fetch(baseDraft + '/api/v1/sites', { headers: { Authorization: 'Bearer ' + currentConfig.apiKey } })
        ...
        .then(function (o) {
          ...
          var found = (o.data.sites || []).find(function (s) { return s.draftId === draftQ; });
...
function saveConfig() {
  currentConfig.apiBaseUrl = document.getElementById('cfg-apiBaseUrl').value || 'https://pagehub.dev';
